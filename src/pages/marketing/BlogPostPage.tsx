...
const BlogPostPage = () => {
  ...
  useEffect(() => {
    ...
    supabase
      .from("blog_posts")
      .select("slug,title,meta_description,content_md,hero_image_url,keywords,category,reading_minutes,published_at,author_name")
      .eq("slug", slug)
      .eq("status", "published")
      .maybeSingle()
      .then(({ data }) => {
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            publisher: {
              "@type": "Organization",
              name: "Megsy AI",
              logo: { "@type": "ImageObject", url: "https://megsyai.com/pwa-512.png" },
            },
