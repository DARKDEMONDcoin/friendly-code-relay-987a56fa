...
const LazyFallback = () => (
  <div className="min-h-dvh w-full bg-background text-foreground flex items-center justify-center px-6">
    <div className="w-full max-w-sm space-y-4" aria-label="Loading Megsy">
      <div className="h-10 w-10 rounded-xl bg-primary/20 animate-pulse" />
      <div className="h-4 w-40 rounded-md bg-foreground/10 animate-pulse" />
      <div className="h-3 w-full rounded-md bg-foreground/[0.06] animate-pulse" />
      <div className="h-3 w-2/3 rounded-md bg-foreground/[0.06] animate-pulse" />
    </div>
  </div>
);
                ...
                <Suspense fallback={<LazyFallback />}>
                  <RouteErrorBoundary>
                    <DeferredRoutes>
                      ...
                      <Route path="/cinema/start-end-frame" element={<Navigate to="/" replace />} />
