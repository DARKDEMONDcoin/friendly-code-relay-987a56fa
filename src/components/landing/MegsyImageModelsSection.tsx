  ...
  return (
    <section id="anchor-image-models-section" className="relative overflow-hidden py-20 md:py-36">
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          <p className="mb-3 text-xs font-bold uppercase tracking-[0.25em] text-pink-400/80">
            {c.kicker}
          </p>
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base text-foreground/50 md:text-lg">{c.subtitle}</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {c.items.map((m, i) => (
            ...
            >
              ...
              <p className="mt-3 text-sm leading-relaxed text-foreground/55">{m.description}</p>
