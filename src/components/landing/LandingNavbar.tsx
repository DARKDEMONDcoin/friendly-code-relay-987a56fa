...
const navItems: NavItem[] = [
  {
    ...
    columns: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Image Studio", desc: "Full AI image editing suite", href: "/images/studio" },
    ...
    featured: {
      title: "Powered by\nMegsy Pro",
      desc: "Experience our most advanced AI model today.",
      cta: "Try it free",
      href: "/auth",
    },
  },
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Cinema Studio", desc: "Long-form cinematic video creation", href: "/cinema" },
          {
            ...
            href: "/videos/tools/thumbnail-generator",
          },
          {
            label: "AI Video Generator",
            desc: "Generate cinematic videos with AI",
                          ...
                          {item.featured && (
                            <div className="group w-[280px] shrink-0 rounded-2xl border border-white/10 flex flex-col items-start relative overflow-hidden">
                              ...
                              <div className="relative z-10 p-6 flex flex-col h-full w-full mt-auto">
                                ...
                                {item.featured.desc && (
                                  <p className="text-sm text-foreground/70 mb-6">{item.featured.desc}</p>
                                )}
                                <button
        ...
        <div className="hidden items-center gap-3 md:flex">
          {user ? (
            ...
            <>
              ...
              <button
                onClick={() => navigate("/auth")}
                className="rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-foreground transition-all hover:scale-[1.03] hover:bg-white/90"
              >
                Start Creating
              </button>
            </>
                        ...
                        {item.columns.map((col) => (
                          <div key={col.title}>
                            ...
                            {col.items.map((sub) => (
                              ...
                              >
                                <div>
                                  <span className="text-sm text-foreground/80">{sub.label}</span>
                                  <span className="block text-xs text-foreground/30">{sub.desc}</span>
                                </div>
                              </button>
                            ))}
                          </div>
