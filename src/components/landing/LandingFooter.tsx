...
const footerLinks = {
  ...
  Resources: [
    { label: "Blog", href: "/blog" },
    {
      ...
      href: "/blog/all-in-one-ai-platform-vs-multiple-subscriptions",
    },
  ...
  return (
    <footer className="border-t border-white/[0.06] bg-black">
      <div className="mx-auto max-w-7xl px-6 py-10 md:py-16">
        ...
        >
          ...
          <div className="col-span-2">
            <div className="mb-4 flex items-center gap-2.5">
              <span className="text-lg font-bold text-foreground">Megsy</span>
            </div>
            <p className="max-w-xs text-sm leading-relaxed text-foreground/25">
              The all-in-one AI creative platform. Chat, generate images & videos, create apps, and
              deploy — all powered by 80+ AI models in one unified interface.
            </p>
            <div className="mt-6 max-w-xs text-[11px] leading-relaxed text-foreground/30">
              <p>
                <a href="mailto:support@megsyai.com" className="text-foreground/55 hover:text-foreground">
                  support@megsyai.com
                </a>
              </p>
            </div>
          ...
          {Object.entries(footerLinks).map(([title, links], colIdx) => (
            ...
            >
              <h4 className="mb-5 text-sm font-bold text-foreground">{title}</h4>
        ...
        >
          <h2
            id="anchor-footer-megsy"
            className="font-display text-[18vw] font-black uppercase leading-[0.85] tracking-tighter text-purple-500/20 md:text-[12vw]"
          >
            MEGSY
          </h2>
        </motion.div>
        ...
        >
          <div className="flex flex-wrap items-center gap-4 text-xs text-foreground/20">
            <a
              href="/terms"
              onClick={(e) => {
                e.preventDefault();
          ...
          <p className="text-xs text-foreground/20">© 2026 Megsy AI. All Rights Reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
