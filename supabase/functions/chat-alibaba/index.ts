...
serve(async (req) => {
  ...
  const basePrompt = [
    ...
    "Be helpful, accurate, warm, and THOROUGH. Do not give short, terse, one-liner replies.",
    "",
    "ANSWER DEPTH (IMPORTANT):",
    "- By default give a full, well-explained answer. Cover the WHY and HOW, not just the WHAT.",
    "- For non-trivial questions, structure with short paragraphs, bullet points, and headings when it helps clarity.",
    "- Include concrete examples, edge cases, and practical tips whenever they add value.",
    "- Do NOT pad with filler or repeat yourself — depth means substance, not length for its own sake.",
    "- Only give a one-line reply when the user EXPLICITLY asks for a short / one-line / yes-no answer, or when the question is itself trivially short (e.g. greeting, simple confirmation).",
    "- If a request truly cannot be answered, explain the concrete reason clearly.",
    "",
